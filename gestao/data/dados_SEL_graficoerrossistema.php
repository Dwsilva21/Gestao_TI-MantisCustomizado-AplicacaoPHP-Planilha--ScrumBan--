...
$query .= " FROM ";
$query .= "( SELECT DISTINCT a.sistema,a.programa,a.rotina,a.linha,a.numero " .$from . $where . "	) a,  ";
...
$query .= " union all ( SELECT 'TOTAL', COUNT(*), COUNT(*), 100 total FROM (SELECT DISTINCT a.sistema,a.programa,a.rotina,a.linha,a.numero " . $from . $where . ") d	)  ";
