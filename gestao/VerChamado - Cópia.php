...
<br>
  <button class="w3-button w3-left w3-red" style="width:250px;" onclick="document.getElementById('id01').style.display='block'">Incluir Anotação <i class="glyphicon glyphicon-user"></i></button>
<br><br>
</div>
...
<table border="0" width="100%" cellspacing="3" cellpadding="4" class="w3-table-all w3-hoverable">
  ...
  <tr class="w3-tiny w3-text-green w3-pale-blue"><td colspan="6" align="center">
