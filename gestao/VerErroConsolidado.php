...
<table border="0" width="100%" cellspacing="3" cellpadding="4" class="w3-table-all w3-hoverable">
  <tr bgcolor="#5555FF" class="w3-green"> 
    ...
    <td width="10%" align="center">Sistema <br><a href="VerErros.php?id=<? echo $id ?>&ord=2"><i class="fa fa-caret-up" <? if ( $ordem == '2' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerErros.php?id=<? echo $id ?>&ord=2 desc"><i class="fa fa-caret-down" <? if ( $ordem == '2 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
    <td width="10%" align="center">Programa <br><a href="VerErros.php?id=<? echo $id ?>&ord=3"><i class="fa fa-caret-up" <? if ( $ordem == '3' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerErros.php?id=<? echo $id ?>&ord=3 desc"><i class="fa fa-caret-down" <? if ( $ordem == '3 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
    <td width="10%" align="center">Rotina <br><a href="VerErros.php?id=<? echo $id ?>&ord=4"><i class="fa fa-caret-up" <? if ( $ordem == '4' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerErros.php?id=<? echo $id ?>&ord=4 desc"><i class="fa fa-caret-down" <? if ( $ordem == '4 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
  ...
  <tr ng-repeat="x in names"> 
    ...
    <td width='05%' align='center' title='{{ x.labelBR }}'  bgcolor='{{ x.color }}'> 
	   <span ng-if=" x.mantis !=  0 "><a href='http://uniondata.com.br/cliente/mantisbt/view.php?id={{ x.mantis }}' target='_blank'> {{ x.mantis }}</a></span>
...
app.controller('Erros', function($scope, $http) {
   $http.get("data/dados_SEL_vererroconsolidado.php?id=<? echo $id ?>&ord=<? echo $ordem ?>")
