...
$pgm = $_REQUEST["pgm"];
if ($pgm == "" ) { $href = "VerAtendimento.php"; }
else { $href = $pgm; }
...
<div class="w3-container">
   ...
   <table border="0" width="100%" cellspacing="3" cellpadding="4" class="w3-table-all w3-hoverable">
     <tr class="w3-light-grey">
       <td colspan="6" align="center"><font size="3" face="Verdana" color="#2499F6"><b><em>[ Chamado ] <?php echo $id ?></em></b></font></td>
     </tr>
   </table>
   ...
   <div ng-app="myApp">
       ...
       <div class="w3-container w3-tiny w3-text-green" ng-controller="Chamado">
          ...
          <div class="w3-half w3-row-padding" ng-repeat="x in names">
              ...
              <text class="w3-input w3-border w3-light-gray" name="cliente" type="text" disabled>{{ x.descricao }}</text>
          </div>	
          <div class="w3-half w3-row-padding" ng-repeat="x in names">	
	   ...
	   <div class="w3-container w3-tiny w3-text-green" ng-controller="Arquivos"  >
	         <table width="100%" class="w3-container w3-tiny w3-text-green"  bgcolor="#3B6EA5">
	            <tr>
		           <td width="20" ng-repeat="w in names" align="center"> 
			       <a href="http://www.uniondata.com.br/cliente/sacanexo/{{ w.idchamado }}_{{ w.nome }}" target="_blank"><img src="image/{{ w.conteudo }}.jpg" width="60" height="60"><br>{{ w.nome }}</a>
			       </td>
				   <td>&nbsp;</td>
		        </tr>	  
	         </table>
       ...
       <div id="id01" class="w3-modal">
          <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:800px"  ng-controller="Chamado">
             ...
             <form class="w3-container " action="data/dados_INS_anotacao.php" name="anotacao" method="POST">
                 <table border="0" width="100%" cellspacing="3" cellpadding="4" class="w3-table-all w3-hoverable">
                    ...
                    <tr class="w3-tiny w3-text-green w3-pale-blue" ng-repeat="z in names" >
					  <td colspan="6" align="center">
                        <input name="digid"  type="hidden" value="<?php echo $id ?>">
                        <input name="digana" type="hidden" value="{{ x.analista }}">
                        <input name="digman" type="hidden" value="{{ x.mantis }}">
                        ...
                        <div class="w3-third w3-row-padding"  >
                            ...
                            <input  class="w3-input w3-border " name="dighor" type="text" value="{{ z.hhmm }}" style="width:30%" maxlength="06">
                        </div>	
       ...
       <div class="w3-container w3-tiny w3-text-green" ng-controller="Anotacoes">
         <table border="0" width="100%" cellspacing="3" cellpadding="4" class="w3-table-all w3-hoverable">
            <tr bgcolor="#5555FF" class="w3-green"> 
                ...
                <td width="10%" align="center">ID <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=1"><i class="fa fa-caret-up" <?php if ( $ordem == '1' ){ echo "style='color:red'"; } ?> title="crescente"></i></a><a href="VerChamado.php?id=<?php echo $id ?>&ord=1 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '1 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
                <td width="08%" align="center">Nome <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=3"><i class="fa fa-caret-up" <?php if ( $ordem == '3' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerChamado.php?id=<?php echo $id ?>&ord=3 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '3 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
                <td width="10%" align="center">Data Hora <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=4"><i class="fa fa-caret-up" <?php if ( $ordem == '4' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerChamado.php?id=<?php echo $id ?>&ord=4 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '4 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
                <td width="45%" align="center">Descrição <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=5"><i class="fa fa-caret-up" <?php if ( $ordem == '5' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerChamado.php?id=<?php echo $id ?>&ord=5 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '5 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
                <td width="10%" align="center">Motivo <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=6"><i class="fa fa-caret-up" <?php if ( $ordem == '6' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerChamado.php?id=<?php echo $id ?>&ord=6 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '6 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
                <td width="10%" align="center">Status <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=7"><i class="fa fa-caret-up" <?php if ( $ordem == '7' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerChamado.php?id=<?php echo $id ?>&ord=7 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '7 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
                <td width="05%" align="center">Tempo <br><a href="VerChamado.php?id=<?php echo $id ?>&ord=8"><i class="fa fa-caret-up" <?php if ( $ordem == '8' ){ echo "style='color:red'"; } ?> title="crescente"></i></a> <a href="VerChamado.php?id=<?php echo $id ?>&ord=8 desc"><i class="fa fa-caret-down" <?php if ( $ordem == '8 desc' ){ echo "style='color:red'"; } ?> title="descrescente"></i></a></td>
            </tr>
...
app.controller('Chamado', function($scope, $http) {
   ...
   $scope.atualiza = function () 
      {	
        $http.get("data/dados_SEL_chamado.php?id=<?php echo $id ?>")
...
app.controller('Anotacoes', function($scope, $http) {
   ...
   $scope.atualiza = function () 
      {	
        $http.get("data/dados_SEL_anotacoes.php?id=<?php echo $id ?>&ord=<?php echo $ordem ?>")
        .then(function (response) {$scope.names = response.data.records;});
      }
   $scope.atualiza();
...
app.controller('Arquivos', function($scope, $http) {
   ...
   $scope.atualiza = function () 
      {	
        $http.get("data/dados_SEL_arquivos.php?id=<?php echo $id ?>")
        .then(function (response) {$scope.names = response.data.records;});
      }
   $scope.atualiza();
...
function limpar()
{
	...
	document.anotacao.dighor.value = "000:00";
...
{
	xerro = "";
	xhora = document.anotacao.dighor.value.substr(0,3);
	xtrac = document.anotacao.dighor.value.substr(3,1);
	xminu = document.anotacao.dighor.value.substr(4,2);
	...
	{
		xerro = "Tempo Inválido (HHH:MM)" ;
	}	

	if (  parseInt(xhora) < 0 || parseInt(xhora) > 160 )
	{
		xerro = "Horas inválidas no campo Tempo (00 a 160) = " + parseInt(xhora) ;
	}	
